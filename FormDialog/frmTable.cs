...
namespace BackendTools.FormDialog
{
    public partial class frmTable : Form
    {
        ...
        public frmTable(UCPocoModels parent)
        {
            InitializeComponent();
            this._parent = parent;
        }
        ...
        private async void btnGenerateFromTable_Click(object sender, EventArgs e)
        {
            ...
            foreach (ListViewItem item in this.lvSelectedTable.Items)
            {
                ...
                sb.Append(await Helper.GeneratePOCOFromTable(item.SubItems[0].Text));
        ...
        {
            string code =  Helper.GeneratePOCOFromListView(lvSelectedColumn);
